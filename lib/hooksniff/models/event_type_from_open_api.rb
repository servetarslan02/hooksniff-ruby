  ...
  class EventTypeFromOpenApi
    ...
    def initialize(attributes = {})
      unless attributes.is_a?(Hash)
        fail(ArgumentError, "The input argument (attributes) must be a hash in `HookSniff::EventTypeFromOpenApi` new method")
      end

      attributes.each do |k, v|
        unless ALL_FIELD.include?(k.to_s)
          fail(ArgumentError, "The field #{k} is not part of HookSniff::EventTypeFromOpenApi")
        end
    ...
    def serialize
      out = Hash.new
      out["deprecated"] = HookSniff::serialize_primitive(@deprecated) unless @deprecated.nil?
